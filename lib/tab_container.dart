...
class _TabContainerState extends State<TabContainer> {
  ...
  Widget _buildTabBar() {
    var listItems = [
      BottomAppBarItem(iconData: Icons.home, text: 'Normal Provider'),
      BottomAppBarItem(iconData: Icons.report_problem, text: 'Normal Issue'),
      BottomAppBarItem(iconData: Icons.settings, text: 'StreamBuilder'),
    ];
